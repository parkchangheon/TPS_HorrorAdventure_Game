...
#include "BTT_ShoulderTackle.generated.h"

/**
 * 
 */
UCLASS()
class TPS_C_PROJECT_API UBTT_ShoulderTackle : public UBTTaskNode
{
	GENERATED_BODY()
public:
	UBTT_ShoulderTackle(FObjectInitializer const& object_initializer);
